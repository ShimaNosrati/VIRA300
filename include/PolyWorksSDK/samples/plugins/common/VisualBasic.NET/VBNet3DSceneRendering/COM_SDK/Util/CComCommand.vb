    ...
    Public Class CComCommand
        ...
        Implements IMPluginLib.IIMCommand2.CmdDeprecatedNamesGet
            ...
            If nbNames > 0 Then
                ...
                Dim deprecatedNames As System.Collections.ArrayList = New System.Collections.ArrayList()
                Dim iName As UInteger = 0

                While iName < nbNames

                    Dim name As String = StrUtil.StrNonNull(m_commandInfo.DeprecatedNameGet(iName))
                ...
                If deprecatedNames.Count > 0 Then

                    Dim deprecatedNamesStr(deprecatedNames.Count - 1) As String
                    names_ = deprecatedNamesStr
