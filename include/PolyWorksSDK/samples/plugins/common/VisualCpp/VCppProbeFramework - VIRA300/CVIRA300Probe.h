#ifndef _CVIRA300PROBE_FRIDAY_OCTOBER252013_091510_H_
#define _CVIRA300PROBE_FRIDAY_OCTOBER252013_091510_H_
// =================================================================================================
...
//   Plug-in implementation
// -------------------------------------------------------------------------------------------------
class CVIRA300Probe : public IReceiver
{
public:
    virtual ~CVIRA300Probe();
...
private:
    ...
    std::unique_ptr< CVIRA300SDKStub > m_pDeviceSDKStub;

    friend CVIRA300Probe& theVIRA300Probe();
    CVIRA300Probe();
};
...
#endif // _CVIRA300PROBE_FRIDAY_OCTOBER252013_091510_H_
