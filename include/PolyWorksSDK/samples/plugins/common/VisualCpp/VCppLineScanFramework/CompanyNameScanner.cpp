...
#include "CompanyNameLineScanner_i.c"
...
{
public:
    DECLARE_LIBID( LIBID_COMPANYNAMELINESCANNERLib );
...
AFX_EXTENSION_MODULE g_afxExtensionModule = { FALSE, nullptr, nullptr, nullptr, nullptr };
...
BEGIN_OBJECT_MAP( ObjectMap )
    OBJECT_ENTRY( CLSID_CompanyNameLineScanner, CCompanyNameScanner )
END_OBJECT_MAP()
...
STDAPI DllRegisterServer( void )
{
    ...
    if ( !AfxOleRegisterTypeLib( g_afxExtensionModule.hModule, LIBID_COMPANYNAMELINESCANNERLib ) )
    {
...
STDAPI DllUnregisterServer( void )
{
    ...
    if ( !AfxOleUnregisterTypeLib( LIBID_COMPANYNAMELINESCANNERLib, wVerMajor, wVerMinor ) )
    {
        return SELFREG_E_TYPELIB;
    }
