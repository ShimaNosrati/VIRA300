...
BEGIN_MESSAGE_MAP( CDlgIMAlign, CDlgCompanyName )
    ...
    ON_EN_KILLFOCUS( IDC_EDIT_SCAN_NAME, OnKillFocusScanName )
END_MESSAGE_MAP()
...
{
    // TODO: Set the enabled state of the controls that must be disabled while scanning
    m_optionsButton.EnableWindow( enable_ );
    m_scanName.EnableWindow( enable_ );
}

// =================================================================================================
//   Reaction to the Options button.
// -------------------------------------------------------------------------------------------------
...
// =================================================================================================
//   Reaction to scan name edit box kill focus.
// -------------------------------------------------------------------------------------------------
