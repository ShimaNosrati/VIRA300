...
#include "CompanyNameNotificationHandler_i.c"
...
STDAPI DllRegisterServer()
{
    ...
    if ( !AfxOleRegisterTypeLib( g_afxExtensionModule.hModule, LIBID_COMPANYNAMENOTIFICATIONHANDLERLib ) )
    {
...
STDAPI DllUnregisterServer()
{
    ...
    if ( !AfxOleUnregisterTypeLib( LIBID_COMPANYNAMENOTIFICATIONHANDLERLib, wVerMajor, wVerMinor ) )
    {
        return SELFREG_E_TYPELIB;
    }
