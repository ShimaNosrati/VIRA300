#ifndef _CVIRA300PROBESETTINGS_FRIDAY_OCTOBER252013_094236_H_
#define _CVIRA300PROBESETTINGS_FRIDAY_OCTOBER252013_094236_H_
// =================================================================================================
...
//   User configuration setting management
// -------------------------------------------------------------------------------------------------
class CVIRA300ProbeSettings
{
public:
    virtual ~CVIRA300ProbeSettings() { }
...
private:
    friend CVIRA300ProbeSettings& theVIRA300ProbeSettings();
    CVIRA300ProbeSettings();
...
#endif // _CVIRA300PROBESETTINGS_FRIDAY_OCTOBER252013_094236_H_
